...
class FrozenDict(Mapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    @overload
    def __init__(self: FrozenDict[str, _VT], __map: SupportsKeysAndGetItem[str, _VT], **kwargs: _VT) -> None: ...
    @overload
    def __init__(self, __iterable: Iterable[tuple[_KT, _VT]]) -> None: ...
    @overload
    def __init__(self: FrozenDict[str, _VT], __iterable: Iterable[tuple[str, _VT]], **kwargs: _VT) -> None: ...
    @overload
    def __init__(self: FrozenDict[str, str], __iterable: Iterable[list[str]]) -> None: ...
    @overload
    def __init__(self: FrozenDict[bytes, bytes], __iterable: Iterable[list[bytes]]) -> None: ...
    ...
    @classmethod
    @overload
    def fromkeys(cls, __iterable: Iterable[_T], __value: None = None) -> FrozenDict[_T, Any | None]: ...
    @classmethod
    @overload
    ...
    if sys.version_info >= (3, 9):
        ...
        @overload
        def __ror__(self, __value: Mapping[_T1, _T2]) -> FrozenDict[_KT | _T1, _VT | _T2]: ...
